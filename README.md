...
| Skill | Description |
|-------|-------------|
| `convex_guidelines` | Build, review, and debug Convex backends with guidance for schema, functions, auth, HTTP routes, actions, scheduling, storage, and TypeScript typing |
