...
import { type Sandbox, makeAgentScopes, makeRoot, makeSandbox, makeSkill, writeMachineConfig } from "./util";
...
test("deny-guarantee verification flags a skill resolvable from a denied agent's dir", () => {
  ...
  upsertPlacement(state, "x", { root: "public", visibility: "public" }, { agent: "shared", path: sharedTarget, kind: "symlink" });
